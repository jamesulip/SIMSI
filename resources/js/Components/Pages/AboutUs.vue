<template>
    <div class="relative ">
      ...
      <div class="relative mx-auto max-w-3xl py-24 flex flex-col px-4 sm:py-32 sm:px-6 lg:px-8">
        <h1 class="text-4xl font-bold tracking-tight text-green-600 sm:text-5xl lg:text-6xl">
          Company Overview
        </h1>
        <p class="mt-6 max-w-3xl text-base leading-relaxed text-white">
        ...
        <div class="flex flex-col mx-auto w-xs  rounded-2xl bg-white shadow-xl mt-10 max-w-md">
        ...
        <div class="mt-6 leading-relaxed text-base text-white bg-[#3c75ca0b] p-1 rounded-md  sm:px-6 lg:px-8">
        ...
        Confidence in the versatility and industry of the Filipinos coupled with the desire in assisting individuals to achieve a rewarding overseas career to secure a better future is the foundation of our organization. Moreover, it is our commitment to maintain the high standards of integrity by providing prompt, efficient and effective service both to our valued employers and Filipino workers.
            Certainly, we are more than glad to be of great service to all our business partners at all times. After all, they are the main reason for our existence in this business.</p>
        </div>
      </div>
    </div>
